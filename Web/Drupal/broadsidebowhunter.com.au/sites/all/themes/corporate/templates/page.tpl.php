...
<div id="wrapper">
  <div class="inwrap">
    <div id="header-top">
        <div class="logo">
            <a href="/" title=""><img src="/sites/default/files/logo.png" /></a>
	  <?php if (theme_get_setting('slideshow_display', 'corporate')): ?>
	  <div id="slideshow">
	    <div id="slides">
	      <div class="slides_container">
		<a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-1.jpg'; ?>"/></a>
	        <a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-2.jpg'; ?>"/></a>
	        <a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-3.jpg'; ?>"/></a>
                <a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-4.jpg'; ?>"/></a>
                <a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-5.jpg'; ?>"/></a>
               <a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-6.jpg'; ?>"/></a>
               <a href="<?php print $front_page; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-7.jpg'; ?>"/></a>
	      </div>
	    </div>
	  </div>
	  <?php endif; ?>
